...
const SocialIcon = ({ label }) => {
  ...
  return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3.3a8.7 8.7 0 1 0 8.7 8.7A8.7 8.7 0 0 0 12 3.3Zm4.84 8.93h-3.37c-.05.75-.16 1.48-.32 2.16 1.1.19 2.12.48 3.02.88.36-.94.59-1.96.67-3.04ZM12 5.12c.63.64 1.18 1.56 1.53 2.69-.5.07-1.01.11-1.53.11s-1.03-.04-1.53-.11C10.82 6.68 11.37 5.76 12 5.12ZM9.16 8.1c-.18.74-.3 1.55-.34 2.37H5.55a6.8 6.8 0 0 1 .67-2.23c.88-.06 1.87-.1 2.94-.14Zm-3.61 3.1h3.27c.04.82.16 1.63.34 2.37-1.07-.04-2.06-.08-2.94-.14a6.8 6.8 0 0 1-.67-2.23Zm3.39 4.06c.5-.07 1.01-.11 1.53-.11s1.03.04 1.53.11c-.35 1.13-.9 2.05-1.53 2.69-.63-.64-1.18-1.56-1.53-2.69Zm3.73 2.31c.51-.69.94-1.55 1.24-2.54.91.13 1.77.34 2.54.62a6.86 6.86 0 0 1-3.78 1.92Zm-1.24-4.47c-.54-.07-1.08-.1-1.63-.1s-1.09.03-1.63.1a17.1 17.1 0 0 1-.35-2.87h3.96c-.04 1.02-.16 1.98-.35 2.87Zm0-4.87H9.46c.04-1.02.16-1.98.35-2.87.54.07 1.08.1 1.63.1s1.09-.03 1.63-.1c.19.89.31 1.85.35 2.87Zm1.87-.13c-.3-.99-.73-1.85-1.24-2.54a6.86 6.86 0 0 1 3.78 1.92c-.77.28-1.63.49-2.54.62Zm3.04 2.8a6.8 6.8 0 0 1 .67 2.23c-.88.06-1.87.1-2.94.14.18-.74.3-1.55.34-2.37h3.27Z" /></svg>;
};
